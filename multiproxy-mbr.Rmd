...
or if you are using RStudio, we recommend that you submit it as a local job so that it does not freeze your RStudio. Alternatively, if you have access to a computing cluster, you can submit the script to your cluster. On a quad-core 3.4 GHz desktop with double threading (effectively 8 cores), the script took about an hour. On a 24-core 2.10 GHz computing node, it took about 20 minutes.
